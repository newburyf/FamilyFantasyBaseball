...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function sortByPos(playerList) {
    ...
    for(let i = 0; i < newList.length; i++) {
      ...
      if(playerList[i].positionCode === "IF") {
        newList[0] = playerList[i];

      } else if(playerList[i].positionCode === "OF") {
